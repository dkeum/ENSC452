...
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ design_1_random_num_generator_0_3_sim_netlist.vhdl
...
p_0_out: unisim.vcomponents.LUT4
    generic map(
      INIT => X"6996"
        ...
        port map (
      I0 => rand_num_output(2),
      I1 => rand_num_output(3),
      I2 => rand_num_output(4),
      I3 => rand_num_output(0),
      O => \p_0_out__0\(7)
    );
\rand_num_output[7]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute CHECK_LICENSE_TYPE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "design_1_random_num_generator_0_3,random_num_generator,{}";
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute x_interface_parameter of axi_clk : signal is "XIL_INTERFACENAME axi_clk, ASSOCIATED_BUSIF m_axis:s_axis:m_axi:s_axi, FREQ_TOLERANCE_HZ 0, PHASE 0.000, CLK_DOMAIN design_1_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0";
  ...
  attribute x_interface_parameter of s_axis_valid : signal is "XIL_INTERFACENAME s_axi, ASSOCIATED_BUSIF m_axis:s_axis:m_axi:s_axi, TDATA_NUM_BYTES 1, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 0, PHASE 0.000, CLK_DOMAIN design_1_processing_system7_0_0_FCLK_CLK0, LAYERED_METADATA undef, INSERT_VIP 0";
