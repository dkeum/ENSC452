...
enum i2s_regs {
	I2S_DATA_RX_L_REG	= 0x00 + XPAR_ZED_AUDIO_CTRL_0_BASEADDR,
	I2S_DATA_RX_R_REG	= 0x04 + XPAR_ZED_AUDIO_CTRL_0_BASEADDR,
	I2S_DATA_TX_L_REG   = 0x08 + XPAR_ZED_AUDIO_CTRL_0_BASEADDR,
	I2S_DATA_TX_R_REG   = 0x0c + XPAR_ZED_AUDIO_CTRL_0_BASEADDR,
	I2S_STATUS_REG      = 0x10 + XPAR_ZED_AUDIO_CTRL_0_BASEADDR,
};
