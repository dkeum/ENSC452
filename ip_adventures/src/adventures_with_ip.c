...
void menu(){
	...
	xil_printf("Enter 's' to stream pure audio \r\n Enter 'r' to record audio \r\n Enter 'p' to play back recorded audio \r\n Enter 'n' to add tonal noise \r\n Enter 'f' to adaptively filter\r\n Enter 'x' to speedup audio \r\n Enter 'y' to slow down audio \r\n  Enter 'z' for sine wave \r\n");
	xil_printf("----------------------------------------\r\n");
...
//	// Wait for input from UART via the terminal
	...
	case 'z':
					xil_printf("Sine Wave MUSIC\r\n");
					xil_printf("Press 'q' to return to the main menu\r\n");
					sine_wave();
					break;
	case 'x':
				xil_printf("SPEED UP MUSIC\r\n");
				xil_printf("Press 'q' to return to the main menu\r\n");
				audio_speedup();
				audio_play();
				break;
	case 'y':
				xil_printf("SLOW DOWN MUSIC\r\n");
				xil_printf("Press 'q' to return to the main menu\r\n");
				audio_slowdown();
				audio_play();
				break;
	case 'r':
			xil_printf("RECORD MUSIC\r\n");
			xil_printf("Press 'q' to return to the main menu\r\n");
			audio_record();
			break;
	case 'p':
			xil_printf("PLAY MUSIC\r\n");
			xil_printf("Press 'q' to return to the main menu\r\n");
			audio_normal_speed();
			audio_play(); // 5 seconds with sampling of 48000Hz = 5*48000 = 240000
			break;
