...
void AudioPllConfig() {
	...
	AudioWriteToReg(R0_CLOCK_CONTROL, 0x0F);	// 1111
												...
												// bit 1:		COREN = Core Clock enabled
}
...
void LineinLineoutConfig() {
	...
	AudioWriteToReg(R5_RECORD_MIXER_LEFT_CONTROL_1, 0x03);//-6 dB gain
	AudioWriteToReg(R6_RECORD_MIXER_RIGHT_CONTROL_0, 0x01);
	AudioWriteToReg(R7_RECORD_MIXER_RIGHT_CONTROL_1, 0x03);//-6 dB gain
