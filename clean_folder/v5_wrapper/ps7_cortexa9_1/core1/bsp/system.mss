...
BEGIN PROCESSOR
 ...
 PARAMETER extra_compiler_flags = -mcpu=cortex-a9 -mfpu=vfpv3 -mfloat-abi=hard -nostartfiles -g -Wall -Wextra -DUSE-AMP=1
END
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = audio_ip_ctrl_axi_gpio_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.1
 PARAMETER HW_INSTANCE = audio_ip_ctrl_zed_audio_ctrl_0
END
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = rand_sys_axi_dma_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axidma
 PARAMETER DRIVER_VER = 9.12
 PARAMETER HW_INSTANCE = sys_cntrl_axi_dma_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.7
 PARAMETER HW_INSTANCE = sys_cntrl_axi_gpio_0
END
