...
-- Command     : write_vhdl -force -mode funcsim -rename_top design_1_rand_num_generator_0_2 -prefix
--               design_1_rand_num_generator_0_2_ design_1_rand_num_generator_0_2_sim_netlist.vhdl
...
entity design_1_rand_num_generator_0_2_inverter is
  port (
...
end design_1_rand_num_generator_0_2_inverter;

architecture STRUCTURE of design_1_rand_num_generator_0_2_inverter is
  signal \m_axis_data[0]_i_2_n_0\ : STD_LOGIC;
  signal p_1_in : STD_LOGIC_VECTOR ( 0 to 0 );
begin
\m_axis_data[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"6996"
    )
        port map (
...
\m_axis_data[0]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"6996"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_rand_num_generator_0_2 is
  port (
    axi_clk : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of design_1_rand_num_generator_0_2 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_rand_num_generator_0_2 : entity is "design_1_rand_num_generator_0_2,inverter,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of design_1_rand_num_generator_0_2 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of design_1_rand_num_generator_0_2 : entity is "package_project";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of design_1_rand_num_generator_0_2 : entity is "inverter,Vivado 2020.2";
end design_1_rand_num_generator_0_2;

architecture STRUCTURE of design_1_rand_num_generator_0_2 is
...
inst: entity work.design_1_rand_num_generator_0_2_inverter
     port map (
      axi_clk => axi_clk,
