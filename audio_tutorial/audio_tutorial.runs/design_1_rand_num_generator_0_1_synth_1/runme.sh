...
HD_PWD='C:/Users/dkeum/audio_tutorial/audio_tutorial/audio_tutorial.runs/design_1_rand_num_generator_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_rand_num_generator_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_rand_num_generator_0_1.tcl
