...
int main()
{
	...
	bin1.draw_Bin(200,20,120,0,(int)0xFF0000FF); //temp value for freq range
	bin2.draw_Bin(200,220,320,0,(int)0x00F00F00); //temp value for freq range
	bin3.draw_Bin(200,420,520,0,(int)0x0000FFFF); //0 is temp value for freq range
	bin4.draw_Bin(200,620,720,0,(int)0x00003000); //temp value for freq range
	bin5.draw_Bin(200,820,920,0,(int)0xFFFFFFFF); //temp value for freq range
	...
	while(1){
		...
		if(isbin3_changed ==1 ){
			...
			bin3.draw_Bin(200,420,520,0,(int)0x0000FFFF); //temp value for freq range
		}
		if(isbin4_changed ==1 ){
