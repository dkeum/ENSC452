...
void Square::draw_Square_flexible_version(int x1,int y1, int size, int color, double rotation, int background_color){
	int length;
		double angle; // used for rotation
		angle = rotation;
		int * image_buffer_pointer = (int *)0x00900000;
					...
					if(rotation != 0){
						...
						if (temp_x <= bin_height_limit){
							if(x > x1+10 && x < x1+length-10 && y > y1+10 && y < y1+length-10){
								...
								image_buffer_pointer[(temp_y)+(temp_x<<10)+(temp_x<<8)]=background_color;
							}
...
void Circle::draw_Circle_flexible_version(int x1, int y1,int size,int color,int background_color){
...
void Triangle::draw_Triangle_flexible_version(int x1, int y1,int size,int color, double rotation,int background_color){
	int radius;
		double angle;
		int adjustment = 3;
		if(size == 1){
...
void Pentagon::draw_Pentagon_flexible_version(int x1, int y1,int size,int color,double rotation,int background_color){
