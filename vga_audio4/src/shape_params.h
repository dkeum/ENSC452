...
class Square: public Shape {
   public:
	...
	void draw_Square_flexible_version(int x1,int y1, int size, int color, double rotation, int background_color);
...
class Triangle: public Shape {
   public:
	...
	void draw_Triangle_flexible_version(int x1, int y1,int size,int color, double rotation,int background_color);
	//void draw_line(int x1,int x2,int y1,int y2, int color); // http://www.brackeen.com/vga/source/djgpp20/lines.c.html
...
//	void draw_Circle(int x1, int y1,int radius,int color);
	...
	void draw_Circle_flexible_version(int x1, int y1,int size,int color,int background_color);
...
class Pentagon: public Shape {
   public:
	...
	void draw_Pentagon_flexible_version(int x1, int y1,int size,int color, double rotation,int background_color);
