...
//	}
	...
	while(1){
//		square.draw_Square_rotation(100+counter,(0*200 + 70),1,(int)0x00003000, rotation);
//		square.draw_Square_rotation(100+counter,(1*200 + 70),2,(int)0x00003000, rotation);
//		square.draw_Square_rotation(100+counter,(2*200 + 70),6,(int)0x00003000, rotation);
//		square.draw_Square_rotation(100+counter,(3*200 + 70),7,(int)0x00003000, rotation);
//		square.draw_Square_rotation(100+counter,(4*200 + 70),8,(int)0xFFFFFFFF, rotation);
//
//		triangle.draw_Triangle((0*200 + 70), 100+counter,1,(int)0xFFFFFFFF, rotation);
//		triangle.draw_Triangle((1*200 + 70), 100+counter,2,(int)0xFFFFFFFF, rotation);
//		triangle.draw_Triangle((2*200 + 70), 100+counter,6,(int)0xFFFFFFFF, rotation);
//		triangle.draw_Triangle((3*200 + 70), 100+counter,7,(int)0xFFFFFFFF, rotation);
//		triangle.draw_Triangle((4*200 + 70), 100+counter,8,(int)0xFFFFFFFF, rotation);

//		pentagon.draw_Pentagon((0*200 + 70), 100+counter,1,(int)0xFFFFFFFF, rotation);
//		pentagon.draw_Pentagon((1*200 + 70), 100+counter,2,(int)0xFFFFFFFF, rotation);
//		pentagon.draw_Pentagon((2*200 + 70), 100+counter,6,(int)0xFFFFFFFF, rotation);
//		pentagon.draw_Pentagon((3*200 + 70), 100+counter,7,(int)0xFFFFFFFF, rotation);
//		pentagon.draw_Pentagon((4*200 + 70), 100+counter,8,(int)0xFFFFFFFF, rotation);


		counter = counter+7;
		rotation=rotation+rotation_amount;

		xil_printf("rotation value is this %lf \r\n",rotation);
		usleep(100000);
//		sleep(1000);
		if(counter > 800)
			counter=0;
...
//
//
//	int mycolor[] = {0xFF0F,0x00F00F00F,0x0000FFFF,0x00003000,0xFFFFFFFF}; //red
