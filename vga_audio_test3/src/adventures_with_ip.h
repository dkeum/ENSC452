...
#define COMM_VAL (*(volatile unsigned long *)(0xFFFF0000)) //shared memory space
#define light_pattern_color (*(volatile unsigned long *)(0xFFFF0010)) // light pattern mode
...
/* TO DO LIST:
 *
 * 1) Implement the audio volume
 * 2) generate shapes
 * 3) check if the button interrupt handlers is working properly
 * 4) check the states
 * 5) update to github
 * 6) commented out sleep.h in design_1_wrapper_2/export.design_1_wrapper_2/sw/vga_compotnent/bspinclude/include/sleep.h
 * */
